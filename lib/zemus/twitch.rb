  ...
  class Twitch
    ...
    def to_embed
      if     @url.split('/').fifth == "b"
        ...
        "<div class='zemusflashembed'><object class='zemusflashembed' bgcolor='#000000' data='http://www.twitch.tv/widgets/archive_embed_player.swf' height='378' id='clip_embed_player_flash' type='application/x-shockwave-flash' width='620'><param name='movie' value='http://www.twitch.tv/widgets/archive_embed_player.swf'><param name='allowScriptAccess' value='always'><param name='allowNetworking' value='all'><param name='allowFullScreen' value='true'><param name='flashvars' value='channel=#{chan}&amp;auto_play=false&amp;start_volume=25&amp;archive_id=#{id}'></object><br><a href='http://www.twitch.tv/#{chan}' class='trk' style='padding:2px 0px 4px; display:block; width: 320px; font-weight:normal; font-size:10px; text-decoration:underline; text-align:center;'>Watch live video from #{chan} on TwitchTV</a></div>
        <div class='zemusnoflash'>Your browser cannot display this embedded Twitch stream.</div>"
        
      elsif  @url.split('/').fifth == "c"
        id = @url.split('/').last
        chan = @url.split('/').fourth
        "<div class='zemusflashembed'><object class='zemusflashembed'  data='http://www.twitch.tv/widgets/archive_embed_player.swf'  id='clip_embed_player_flash' type='application/x-shockwave-flash'><param name='movie' value='http://www.twitch.tv/widgets/archive_embed_player.swf'><param name='allowScriptAccess' value='always'><param name='allowNetworking' value='all'><param name='allowFullScreen' value='true'><param name='flashvars' value='channel=#{chan}&amp;auto_play=false&amp;start_volume=25&amp;chapter_id=#{id}'></object><br><a href='http://www.twitch.tv/#{chan}' class='trk' style='padding:2px 0px 4px; display:block; width: 320px; font-weight:normal; font-size:10px; text-decoration:underline; text-align:center;'>Watch live video from #{chan} on TwitchTV</a></div>
        <div class='zemusnoflash'>Your browser cannot display this embedded Twitch stream.</div>"
      else 
        chan = @url.split('/').fourth
